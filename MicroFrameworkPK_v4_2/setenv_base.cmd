...
IF "%MDK_EXT%"=="3" (
  SET MDK_EXT=31
  SET RVCT31BIN=%MDK_TOOL_PATH%\ARM\BIN%MDK_EXT%
  SET RVCT31LIB=%MDK_TOOL_PATH%\RV31\LIB
  SET RVCT31INC=%MDK_TOOL_PATH%\RV31\INC
)
IF "%MDK_EXT%"=="4" (
  IF "%MDK_SUB_EXT%" GEQ "54" (
    SET MDK_EXT=40
    SET RVCT40BIN=%MDK_TOOL_PATH%\ARMCC\BIN
    SET RVCT40LIB=%MDK_TOOL_PATH%\ARMCC\LIB
    SET RVCT40INC=%MDK_TOOL_PATH%\ARMCC\INC
  ) ELSE (
    SET MDK_EXT=31
    SET RVCT31BIN=%MDK_TOOL_PATH%\ARM\BIN%MDK_EXT%
    SET RVCT31LIB=%MDK_TOOL_PATH%\RV31\LIB
