...
//  Tested with NXP LPC43XX: Micromint USA <support@micromint.com>
//
//  CORTEX-M Interrupt Disable Handling 
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
__section(SectionForFlashOperations) SmartPtr_IRQ::SmartPtr_IRQ(void* context)
{
    asm("MRS r2,PRIMASK");
    asm("CPSID i");
...
__section(SectionForFlashOperations) SmartPtr_IRQ::~SmartPtr_IRQ()
{
    asm("LDR r1,[r0,%[state]]"::[state]"l"(offsetof(SmartPtr_IRQ, m_state)));
    asm("MSR PRIMASK, r1");
}

BOOL __section(SectionForFlashOperations) SmartPtr_IRQ::WasDisabled()
{
    asm("MRS r1,IPSR");
...
void __section(SectionForFlashOperations) SmartPtr_IRQ::Acquire()
{
    asm("CPSID i");
}

void __section(SectionForFlashOperations) SmartPtr_IRQ::Release()
{
    asm("LDR r1,[r0, %[state]]"::[state]"l"(offsetof(SmartPtr_IRQ, m_state)));
    asm("MSR PRIMASK,r1");
}

void __section(SectionForFlashOperations) SmartPtr_IRQ::Probe()
{
    asm("LDR r1,[r0,%[state]]"::[state]"l"(offsetof(SmartPtr_IRQ, m_state)));
    asm("MRS r2, PRIMASK");
    asm("MSR PRIMASK, r1");
...
BOOL __section(SectionForFlashOperations) SmartPtr_IRQ::GetState(void* context)
{
    asm("MRS r0, PRIMASK");
    asm("MRS r1, IPSR");
    asm("EOR r0, r0, #1");
...
BOOL __section(SectionForFlashOperations) SmartPtr_IRQ::ForceDisabled(void* context)
{
    asm("MRS r0, PRIMASK");
    asm("CPSID i");
    asm("EOR r0, r0, #1");
...
BOOL __section(SectionForFlashOperations) SmartPtr_IRQ::ForceEnabled(void* context)
{
    asm("MRS r0, PRIMASK");
    asm("CPSIE i");
    asm("EOR r0, r0, #1");
...
void __section(SectionForFlashOperations) SmartPtr_IRQ::Disable()
{
    asm("MRS r1,PRIMASK");
    asm("CPSID i");
...
void __section(SectionForFlashOperations) SmartPtr_IRQ::Restore()
{
    asm("LDR r1, [r0, %[state]]"::[state]"l"(offsetof(SmartPtr_IRQ, m_state)));
    asm("MSR PRIMASK, r1");
}
