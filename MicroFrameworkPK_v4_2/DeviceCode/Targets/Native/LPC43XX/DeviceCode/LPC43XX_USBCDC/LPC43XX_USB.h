...
#define RET_OK         LPC_OK
#define RET_UNHANDLED  ERR_USBD_UNHANDLED
...
#define USB_EP_INDEX_OUT(addr)                 ((addr) << 1)
#define USB_EP_INDEX_IN(addr)                  (((addr) << 1) + 1)
...
/* ---------- HW_USBD_H ---------- */
/* IP9208 USB-OTG device controller definitions */
#ifndef _BIT
...
#define USBD_DataInStage           USBD_API->core->DataInStage
#define USBD_DataOutStage          USBD_API->core->DataOutStage
#define USBD_StatusInStage         USBD_API->core->StatusInStage
#define USBD_StatusOutStage        USBD_API->core->StatusOutStage

#define USBD_Init                  USBD_API->hw->Init
#define USBD_Connect               USBD_API->hw->Connect
#define USBD_ISR                   USBD_API->hw->ISR
#define USBD_EnableEvent           USBD_API->hw->EnableEvent
#define USBD_ReadSetupPkt          USBD_API->hw->ReadSetupPkt
